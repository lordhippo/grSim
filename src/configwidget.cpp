...
{      
  ...
  robot_settings = new QSettings;
    ...
    geo_vars->addChild(field_vars);
        ...
        ADD_VALUE(field_vars,Double,Field_Penalty_Rad,1.000,"Penalty radius")
        ADD_VALUE(field_vars,Double,Field_Penalty_Line,0.500,"Penalty line length")
        ADD_VALUE(field_vars,Double,Field_Penalty_Point,1.000,"Penalty point")
        ADD_VALUE(field_vars,Double,Field_Margin,0.300,"Margin")
        ADD_VALUE(field_vars,Double,Field_Referee_Margin,0.400,"Referee margin")
